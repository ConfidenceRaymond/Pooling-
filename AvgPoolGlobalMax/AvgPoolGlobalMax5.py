...
conv_1 = conv_2d(network, nb_filter=32, filter_size=3, activation='relu', name='conv_1')
print("conv_1")

# 2:batch normalization
network = batch_normalization(conv_1)
print("batch_norm")
...
# 4: Convolution layer with 16 filters, each 3x3
conv_2 = conv_2d(network, nb_filter=16, filter_size=3, activation='relu', name='conv_2')
print("conv_2")

# 5: batch normalization
network = batch_normalization(conv_2 , 0.5)
print("batch_norm")
...
# 7: Convolution layer with 8 filters, each 3x3
conv_3 = conv_2d(network, nb_filter=8, filter_size=3, activation='relu', name='conv_3')
print("conv_3")

# 8:  batch normalization
network = batch_normalization(conv_3 , 0.5)
print("batch_norm")
...
# 10: Convolution layer with 16 filters, each 3x3
conv_4 = conv_2d(network, nb_filter=16, filter_size=3, activation='relu', name='conv_4')
print("conv_3")

# 11: batch normalization
network = batch_normalization(conv_4 , 0.5)
print("batch_norm")
...
# 14: Fully-connected 1024 nodes layer -> activation function = ReLU
