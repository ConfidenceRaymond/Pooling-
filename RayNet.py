...
network = input_data(shape=[None, IMGsize, IMGsize, 3], name='input')

neta1= conv_2d(network, 8, 5, padding='same', activation='relu', regularizer="L2")
neta2= conv_2d(network, 8, 3, padding='same', activation='relu', regularizer="L2")
neta3= conv_2d(network, 8, 1, padding='same', activation='relu', regularizer="L2")
network = merge([neta1, neta2, neta3], mode='concat', axis=1)
...
netb1= conv_2d(network, 8, 5, padding='same', activation='relu', regularizer="L2")
netb2= conv_2d(network, 8, 3, padding='same', activation='relu', regularizer="L2")
netb3= conv_2d(network, 8, 1, padding='same', activation='relu', regularizer="L2")
network = merge([netb1, netb2, netb3], mode='concat', axis=1)
...
conv_3 = conv_2d(network, nb_filter=128, filter_size=3, activation='relu', name='conv_3')
print("layer 1")
