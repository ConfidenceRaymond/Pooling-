...
# 1: Convolution layer with 64 filters, each 3x3
conv_1 = conv_2d(network, nb_filter=64, filter_size=3, activation='relu', strides=1, name='conv_1')
print("conv_1")

# 2: Convolution layer with 64 filters, each 3x3
conv_2 = conv_2d(conv_1, nb_filter=64, filter_size=3, activation='relu', strides=1, name='conv_2')
print("conv_2")

# 3: Average pooling layer
network = avg_pool_2d(conv_2, 2)
print("avg_pool_2d")

# 4: Convolution layer with 128 filters -> filter size = 3x3
conv_3 = conv_2d(network, nb_filter=128, filter_size=3, activation='relu', strides=1, name='conv_3')
print("conv_3")

# 5: Convolution layer with 128 filters -> filter size = 3x3
conv_4 = conv_2d(conv_3, nb_filter=128, filter_size=3, activation='relu', strides=1, name='conv_4')
print("conv_5")

# 6: Average pooling layer
network = avg_pool_2d(conv_4, 2)
print("avg_pool_2d")

# 7: Convolution layer with 256 filters -> filter size = 3x3
conv_5 = conv_2d(network, nb_filter=256, filter_size=3, activation='relu', strides=1, name='conv_5')
print("conv_5")

# 8: Convolution layer with 256 filters -> filter size = 3x3
conv_6 = conv_2d(conv_5, nb_filter=256, filter_size=3, activation='relu', strides=1, name='conv_6')
print("conv_6")

# 9: Convolution layer with 256 filters -> filter size = 3x3
conv_7 = conv_2d(conv_6, nb_filter=256, filter_size=3, activation='relu', strides=1, name='conv_7')
print("conv_7")

# 10: Convolution layer with 256 filters -> filter size = 3x3
conv_8 = conv_2d(conv_7, nb_filter=256, filter_size=3, activation='relu', strides=1, name='conv_8')
print("conv_8")

# 11: Average pooling layer
network = avg_pool_2d(conv_8, 2)
print("avg_pool_2d")

# 12: Convolution layer with 512 filters -> filter size = 3x3
conv_9 = conv_2d(network, nb_filter=512, filter_size=3, activation='relu', strides=1, name='conv_9')
print("conv_9")

# 13: Convolution layer with 512 filters -> filter size = 3x3
conv_10 = conv_2d(conv_9, nb_filter=512, filter_size=3, activation='relu', strides=1, name='conv_10')
print("conv_10")

# 14: Convolution layer with 512 filters -> filter size = 3x3
conv_11 = conv_2d(conv_10, nb_filter=512, filter_size=3, activation='relu', strides=1, name='conv_11')
print("conv_11")

# 14: Convolution layer with 512 filters -> filter size = 3x3
conv_12 = conv_2d(conv_11, nb_filter=512, filter_size=3, activation='relu', strides=1, name='conv_12')
print("conv_12")

# 15: Average pooling layer
network = avg_pool_2d(conv_12, 2)
print("avg_pool_2d")

# 16: Fully-connected 4096 nodes layer -> activation function = ReLU
network = fully_connected(network, 4096, activation='relu')
print("Fully-connected1")

# 17: Dropout layer to combat overfitting
network = dropout(network, 0.5)
print("dropout")

# 18: Fully-connected 4096 nodes layer -> activation function = ReLU
network = fully_connected(network, 4096, activation='relu')
print("Fully-connected2")

# 19: Dropout layer to combat overfitting
network = dropout(network, 0.5)
print("dropout")

# 20: Fully-connected 4096 nodes layer -> activation function = ReLU
network = fully_connected(network, 5, activation='softmax')
print("Fully-connected3")
