...
conv_1 = conv_2d(network, nb_filter=16, strides=2, padding='SAME', filter_size=5, activation='relu', name='conv_1')
print("conv_1")

# 2: Dropout layer to combat overfitting
network = dropout(conv_1 , 0.5)
print("dropout")
...
# 4: Convolution layer with 32 filters, each 3x3
conv_2 = conv_2d(network, nb_filter=32, filter_size=3, strides=2, padding='SAME', activation='relu', name='conv_2')
print("conv_2")

# 5: Dropout layer to combat overfitting
network = dropout(conv_2 , 0.5)
print("dropout")
...
# 7: Convolution layer with 64 filters, each 3x3
conv_3 = conv_2d(network, nb_filter=64, filter_size=3, strides=1, padding='SAME', activation='relu', name='conv_3')
print("conv_3")
...
# 10: Convolution layer with 128 filters, each 3x3
conv_4 = conv_2d(network, nb_filter=128, filter_size=3, strides=1, padding='SAME', activation='relu', name='conv_4')
print("conv_3")

# 11: Dropout layer to combat overfitting
network = dropout(conv_4 , 0.5)
print("dropout")
...
# 13: Max pooling layer
network = global_avg_pool(network, name='GlobalavgPool')
print("GlobalavgPool")

# 14: Fully-connected 4096 nodes layer -> activation function = ReLU
