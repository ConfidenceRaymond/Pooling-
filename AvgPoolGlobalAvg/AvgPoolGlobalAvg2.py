...
from tflearn.layers.conv import conv_2d, avg_pool_2d, global_max_pool, global_avg_pool
...
network = global_avg_pool(network, name='GlobalavgPool')
print("GlobalavgPool1")

# 18: Dropout layer to combat overfitting
network = dropout(network, 0.5)
print("dropout")

# 19: Fully-connected 4096 nodes layer -> activation function = ReLU
